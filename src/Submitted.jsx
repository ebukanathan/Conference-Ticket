...
function Submitted({ images, inputs }) {
  return (
    <>
      <div className="relative  bg-[url('./assets/images/background-desktop.png')] bg-cover bg-center bg-no-repeat">
        ...
        <div className=" absolute inset-x-7 top-0 flex flex-col text-white  gap-5 justify-center items-center w-full mx-auto p-5 ">
          ...
          <div className="text-6xl text-bold text-center capitalize ">
            congrats hjjj your ticket is ready
          </div>
          <p className="text-sm">we ve emailed your ticket to email</p>
          <div className="bg-[url('./assets/images/pattern-ticket.svg')] bg-no-repeat p-8 w-1/2 h-[50vh]  text-white">
            <div className="flex justify-between items-center">
              ...
              <div className="rotate-90 mt-8">#12340</div>
            </div>
          </div>
        </div>
      </div>
